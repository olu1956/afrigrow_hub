...
export const partnerOffers: PartnerOffer[] = [
  ...
  },
  {
    ...
    headline: "Create, manage, and monetise events with ease",
    description:
      "Event Junction helps organisers sell tickets, send QR invites, manage guest lists, track budgets, and run marketing campaigns — from intimate gatherings to large-scale conferences. Comprehensive event tools that cut complexity and grow revenue potential.",
    offer: "Free to download · Plus & Pro upgrades in app",
    ctaLabel: "Download on App Store",
    ctaHref: "https://apps.apple.com/app/id6758195465",
    logoSrc: "/partners/event-junction.png",
    verified: true,
  ...
  },
  {
    ...
    headline: "Grow your life and your mood — free on the App Store",
    description:
      "Motivational lifestyle coaching for African communities: A–Z life skills, games, wellness, and progress tracking. Grow your business on AfriGrow — grow yourself with About Life.",
    offer: "Free to download · 7-day account trial",
    ctaLabel: "Download on App Store",
    ctaHref: "https://apple.co/4p6EEB2",
    logoSrc: "/partners/about-life.png",
    verified: true,
    cardTheme: "from-[#0b1f3a] via-[#123354] to-[#1a4a6e]",
  },
  {
    id: "afrigrow",
    name: "AfriGrow Hub",
    ...
    offer: "Founding members — free to start",
    ctaLabel: "Join AfriGrow free",
    ctaHref: "/signup",
